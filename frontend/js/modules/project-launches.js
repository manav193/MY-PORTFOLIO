...
export function initProjectLaunch(){
  const params=new URLSearchParams(location.search);const path=location.pathname;const publicPage=path.includes('/assets/case-studies/public-project.html');const publicId=params.get('id');
  if(publicPage&&publicId==='fate-ai'){loadLaunch({css:'../../assets/case-studies/fate-launch.css',js:'../../assets/case-studies/fate-launch.js',activeClass:'fate-launch-active'});return;}
  if(publicPage&&publicId==='flora-and-flavor'){loadLaunch({css:'../../assets/case-studies/flora-launch.css',js:'../../assets/case-studies/flora-launch.js',activeClass:'flora-launch-active'});return;}
  ...
  if(path.endsWith('/assets/case-studies/veldora-bites.html')||path.endsWith('assets/case-studies/veldora-bites.html')){loadLaunch({css:'veldora-launch.css',js:'../../assets/case-studies/veldora-launch.js',activeClass:'veldora-launch-active'});return;}
  ...
  if(file==='project-nimo.html'){
    ...
    addStyle('assets/case-studies/nimo-premium.css');
    import('../../assets/case-studies/nimo-case-study-lab.js').catch(()=>{});
    return;
  }
  const staticLaunches={'project-promptai.html':['prompt-launch.css','prompt-launch.js','prompt-launch-active'],'project-toolverse.html':['toolverse-launch.css','toolverse-launch.js','toolverse-launch-active'],'project-shift-zero.html':['shiftzero-launch.css','shiftzero-launch.js','shiftzero-launch-active'],'project-arcade-os.html':['arcade-launch.css','arcade-launch.js','arcade-launch-active']};
